    ...
    fun setNotificationDefaults(
        ...
        when (notificationMode) {
            NOTIFICATION_MODE_NONE -> {
                Logger.logWarn(
                    LOG_TAG,
                    "The NOTIFICATION_MODE_NONE passed to setNotificationDefaults(), force setting builder to null."
                )
            ...
            NOTIFICATION_MODE_ALL -> {
                ...
                Logger.logError(
                    LOG_TAG,
                    "Invalid notificationMode: \"$notificationMode\" passed to setNotificationDefaults()"
                )
            }
        }
