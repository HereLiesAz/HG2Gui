...
import com.hereliesaz.hg2gui.commands.main.raw.shortcut;
...
import static com.hereliesaz.hg2gui.managers.xml.XMLPrefsManager.VALUE_ATTRIBUTE;
import static com.hereliesaz.hg2gui.managers.xml.XMLPrefsManager.resetFile;
...
public class NotesManager {
    ...
    public static String ACTION_RM = "com.hereliesaz.hg2gui" + ".rm_note";
    public static String ACTION_ADD = "com.hereliesaz.hg2gui" + ".add_note";
    public static String ACTION_CLEAR = "com.hereliesaz.hg2gui" + ".clear_notes";
    public static String ACTION_LS = "com.hereliesaz.hg2gui" + ".ls_notes";
    public static String ACTION_LOCK = "com.hereliesaz.hg2gui" + ".lock_notes";
    public static String ACTION_CP = "com.hereliesaz.hg2gui" + ".cp_notes";
