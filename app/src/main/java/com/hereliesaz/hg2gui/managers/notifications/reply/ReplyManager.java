package com.hereliesaz.hg2gui.managers.notifications.reply;
...
public class ReplyManager implements XMLPrefsElement {
    ...
    public static String ACTION = "com.hereliesaz.hg2gui" + ".reply";
    public static String ID = "id";
    public static String WHAT = "what";
    public static String ACTION_UPDATE = "com.hereliesaz.hg2gui" + ".update";
    public static String ACTION_LS = "com.hereliesaz.hg2gui" + ".lsreplies";
