...
public class PublicIOReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_OUTPUT = "com.hereliesaz.hg2gui" + ".action_public_output";
    public static final String ACTION_CMD = "com.hereliesaz.hg2gui" + ".action_public_cmd";
