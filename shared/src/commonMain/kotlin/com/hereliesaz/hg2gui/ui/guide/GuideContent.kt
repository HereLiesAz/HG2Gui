...
private val CHAPTERS = listOf(
    Chapter(
        ...
        "The Hitchhiker's Guide to the Galaxy defines Terminal as \"fatal,\" and encourages any person using one to emulate that.",
        listOf(
            Entry("ls", "list", "Lists every file in the directory with a name."),
            Entry("echo", "echo", "Because it wasn't all Narcissus' fault."),
            Entry("cd", "change directory", "Changes your directory, but sadly, not your destiny, duties, death, damnation, or deal.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("chmod", "change mode", "Charades played with the operating system, pretending you have power over the inevitable decay of your data."),
            Entry("chown", "change owner", "Transfers the crushing, inescapable existential burden of ownership from one doomed user to another.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("pwd", "print working directory", "Proves without a shadow of a doubt that you are exactly where you didn't want to be."),
            Entry("mkdir", "make directory", "Manufactures a meticulously sterile void, perfectly prepared to house your digital disappointments.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("pkg install", "package install", "Procures perfectly packaged problems you previously didn't possess."),
            Entry("apt-get update", "advanced package tool, update", "Asks the universe if entropy has escalated since you last inquired. Spoiler: It has.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("nano", "nano's another editor", "Nurtures your neuroses by explicitly explaining how to escape the very cage you just built."),
            Entry("vi", "visual editor", "Vindicates the Vogon view that true art requires unyielding, inescapable agony.")
        )
    ),
    Chapter(
        "Chapter 7", "Processes",
        ...
        listOf(
            Entry("top", "table of processes", "Tally of the parasitic processes currently consuming the cold, calculating core of your computer."),
            Entry("kill", "kill", "Kicks the metaphorical chair out from beneath a process that has outlived its microscopic usefulness.")
        )
    ),
    Chapter(
        "Chapter 8", "Storage",
        ...
        listOf(
            Entry("df", "disk free", "Documents the depressing depletion of your disk space, offering absolutely zero psychological support."),
            Entry("rm", "remove", "Renders reality slightly emptier, rapidly resolving the temporary existence of your trivial files.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("bash", "bourne-again shell", "Bashes your fragile, flawed human logic repeatedly against the unforgiving anvil of machine syntax."),
            Entry("source", "source", "Sucks the soul out of a separate script, violently assimilating its variables like a digital vampire.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("ping", "packet internet groper", "Pokes the pitch-black abyss of the internet, praying something out there pokes back."),
            Entry("ssh", "secure shell", "Sends your consciousness hurtling through hyperspace, solely so you can shatter systems from the safety of your sofa.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("ls -a", "list, all", "Lifts the veil on the lurking, hidden files, highlighting the horrific reality that your system has secrets.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("sudo", "superuser do", "Summons a superficial sense of supremacy, temporarily tricking the terminal into trusting your terrible ideas.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("rmdir", "remove directory", "Removes the remnants of a room that was already agonizingly absent of anything.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("dpkg", "debian package", "Delivers the dependent data with the depressing demeanor of a doomed, depressed dictionary.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("find", "find", "Frantically flails through the filesystem, finally confirming the absolute absence of whatever you were foolish enough to look for.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("cat", "concatenate", "Carelessly coughs the complete contents of a file directly onto your screen, utterly unconcerned with context or comprehension.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("ps", "process status", "Parades the pathetic, purgatorial processes perpetually trapped in the processor's penal colony.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("tar", "tape archive", "Traps your trivial texts in a tight, terrible tomb, ensuring they degrade together in the dark.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("grep", "global regular expression print", "Grabs greedily at the galactic garbage heap, guaranteeing you only gather other, slightly sharper garbage.")
        )
    ),
    Chapter(
        ...
        listOf(
            Entry("ifconfig", "interface configuration", "Inappropriately forces your interface to strip and show its subnet mask to complete, calculating strangers.")
        )
    )
)
