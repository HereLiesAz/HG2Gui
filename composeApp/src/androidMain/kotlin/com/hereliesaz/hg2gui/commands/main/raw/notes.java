...
public class notes extends ParamCommand {
    ...
    private enum Param implements com.hereliesaz.hg2gui.commands.main.Param {
        ...
        add {
            ...
            public String exec(ExecutePack pack) {
                ...
                LocalBroadcastManager.getInstance(((MainPack) pack).androidContext).sendBroadcast(i);
                return null;
            }
        },
        rm {
        ...
        tutorial {
            ...
            @Override
            public String exec(ExecutePack pack) {
                ((MainPack) pack).androidContext.startActivity(Tuils.webPage("https://github.com/Andre1299/TUI-ConsoleLauncher/wiki/Notes"));
                return null;
            }
        };
    ...
    @Override
    protected com.hereliesaz.hg2gui.commands.main.Param paramForString(MainPack pack, String param) {
