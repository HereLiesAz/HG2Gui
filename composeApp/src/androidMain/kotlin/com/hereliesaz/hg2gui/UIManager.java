...
import com.hereliesaz.hg2gui.managers.NotesManager;
...
import com.hereliesaz.hg2gui.tuils.OutlineEditText;
...
public class UIManager implements OnTouchListener {
    ...
    public static String ACTION_NOROOT = "com.hereliesaz.hg2gui" + ".ui_noroot";
    public static String ACTION_LOGTOFILE = "com.hereliesaz.hg2gui" + ".ui_log";
    public static String ACTION_CLEAR = "com.hereliesaz.hg2gui" + "ui_clear";
    public static String ACTION_WEATHER = "com.hereliesaz.hg2gui" + "ui_weather";
    public static String ACTION_WEATHER_GOT_LOCATION = "com.hereliesaz.hg2gui" + "ui_weather_location";
    public static String ACTION_WEATHER_DELAY = "com.hereliesaz.hg2gui" + "ui_weather_delay";
    public static String ACTION_WEATHER_MANUAL_UPDATE = "com.hereliesaz.hg2gui" + "ui_weather_update";
    public static String ACTION_PANIC = "com.hereliesaz.hg2gui" + ".ui_panic";
