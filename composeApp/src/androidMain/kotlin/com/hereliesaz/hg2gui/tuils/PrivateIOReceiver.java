...
import com.hereliesaz.hg2gui.DontPanicActivity;
...
//    show custom output
    ...
    public static final String ACTION_INPUT = "com.hereliesaz.hg2gui" + ".action_input";
    public static final String ACTION_REPLY = "com.hereliesaz.hg2gui" + ".action_reply";

    public static final String TEXT = "com.hereliesaz.hg2gui" + ".text";
    public static final String TYPE = "com.hereliesaz.hg2gui" + ".type";
    public static final String COLOR = "com.hereliesaz.hg2gui" + ".color";
    public static final String ACTION = "com.hereliesaz.hg2gui" + ".action";
    public static final String LONG_ACTION = "com.hereliesaz.hg2gui" + ".longaction";
    public static final String REMOTE_INPUTS = "com.hereliesaz.hg2gui" + ".remote_inputs";
    public static final String BUNDLE = "com.hereliesaz.hg2gui" + ".bundle";
    public static final String PENDING_INTENT = "com.hereliesaz.hg2gui" + ".pending_intent";
    public static final String ID = "com.hereliesaz.hg2gui" + ".id";
    public static final String CURRENT_ID = "com.hereliesaz.hg2gui" + ".current_id";
    public static final String INFO_AREA = "com.hereliesaz.hg2gui" + ".info_area";
