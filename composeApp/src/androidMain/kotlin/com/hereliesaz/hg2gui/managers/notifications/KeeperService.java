package com.hereliesaz.hg2gui.managers.notifications;
...
import static com.hereliesaz.hg2gui.managers.TerminalManager.FORMAT_INPUT;
import static com.hereliesaz.hg2gui.managers.TerminalManager.FORMAT_NEWLINE;
import static com.hereliesaz.hg2gui.managers.TerminalManager.FORMAT_PREFIX;
    ...
    public static Notification buildNotification(Context c, String title, String subtitle, String cmdLabel, String clickCmd, boolean showHome, CharSequence[] lastCommands, boolean upDown, int priority) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                ...
                NotificationChannel notificationChannel = new NotificationChannel("com.hereliesaz.hg2gui", c.getString(R.string.app_name), oPriority);
                ((NotificationManager) c.getSystemService(Context.NOTIFICATION_SERVICE)).createNotificationChannel(notificationChannel);
            }

            NotificationCompat.Builder builder = new NotificationCompat.Builder(c, "com.hereliesaz.hg2gui")
