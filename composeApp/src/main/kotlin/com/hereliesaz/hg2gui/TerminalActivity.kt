            ...
            HG2GuiTheme(scale = fontScalePercent / 100f) {
                ...
                when {
                    ...
                    sessions.isNotEmpty() && currentTree != null -> TerminalScreen(
                        ...
                        onRun = { sessionId, line, onOutput, onNeedInput, onExit, onStyledOutput ->
                            val session = sessions.first { it.ui.id == sessionId }
                            session.engine.run(line, onNeedInput, onExit, onStyledOutput).collect { output -> onOutput(output) }
